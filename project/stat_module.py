...
from detector_module import fetchtest_set,fetchmachine
...
def plotgraph():
    ...
    totalPositives,truePositives,falsePositives,totalNegatives,trueNegatives,falseNegatives=statistical_analysis()
